...
gui_main.py
Es el punto de entrada para la interfaz visual. Permite al usuario interactuar mediante formularios intuitivos con validaciones en tiempo real, visualizar la cuota calculada, explorar la tabla de acumulación detallada con desplazamiento (*scroll*) y revisar el resumen de totales.
...
*(Nota: la interfaz por consola y las pruebas unitarias no requieren librerías externas).*
